    ...
    <div class="blog-card-group">
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    This NoSQL database oriented to documents (by documents like JSON) combines some of the features
                    from
                    relational
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    It's awesome to build sites that are inclusive and accessible to everyone. There are at least six
                    key
                    areas of
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    ...
                    Any user can have a slow experience. In a world with widely varying device capabilities, a
                    "one-size"
                    fits all
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    We, as developers, tend to develop sites unconsciously for people like ourselves. If we don't
                    actively
                    pay attention,
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    ...
                    data with
                    suggestions for how to improve. The V5 API includes lab data from Lighthouse and real-world data
                    from
                    the Chrome User
        ...
        <div class="blog-card">
            ...
            <div class="blog-content-wrapper">
                ...
                <p class="blog-text">
                    ...
                    utilizing
                    Javascript for both the backend and frontend as well as a document-oriented or non relational
                    database
                    (MongoDB),
